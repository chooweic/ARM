...
// Takes in Offset x,y from center of tracked visual marker, produces a set of Marker at the offset.
function Marker(offX, offY, title, desc, url) {
    this.urlStr = url;
    this.titleStr = title;
    this.descStr = desc;
    ...
    */
    ...
    this.markerDrawable_idle = new AR.ImageDrawable(new AR.ImageResource("assets/marker_idle.png"), 0.25, {
        zOrder: 0,
        opacity: 1.0,
        offsetY: offY,
        offsetX: offX,
    ...
    this.markerDrawable_selected = new AR.ImageDrawable( new AR.ImageResource("assets/marker_selected.png"), 0.25, {
        zOrder: 0,
        opacity: 0.0,
        offsetY: offY,
        offsetX: offX,
    ...
    this.titleLabel = new AR.Label(title.trunc(15), 0.1, {
        zOrder: 1,
        offsetY: 0.055 + offY,
        offsetX: offX,
        style: {
    ...
    this.descriptionLabel = new AR.Label(desc.trunc(20), 0.08, {
        zOrder: 1,
        offsetY: -0.055 + offY,
       offsetX: offX,
        style: {
